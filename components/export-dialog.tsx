...
import { FileText, Link, FileImage } from "lucide-react";
  ...
  const handleExportImage = useCallback(() => {
    ...
    toPng(targetRef.current, { cacheBust: true })
      .then((dataUrl) => {
        ...
        link.href = dataUrl;
        link.click();
        toast({ description: "Image exported succesfully" });
      })
      .catch((err) => {
  ...
  const handleExportSVG = useCallback(() => {
    ...
    toSvg(targetRef.current, { cacheBust: true })
      .then((dataUrl) => {
        ...
        link.href = dataUrl;
        link.click();
        toast({ description: "SVG exported successfully" });
      })
      .catch((err) => {
      ...
      <DialogContent>
        ...
        <div className="flex items-center gap-3 p-3">
          <div
            ...
            className="bg-[#f7f7f8] hover:bg-stone-200 cursor-pointer w-[25%] p-5 
            rounded-xl justify-center  text-center text-sm flex flex-col"
          >
